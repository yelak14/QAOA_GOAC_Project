...
def plot_bitstring_probability(final_distribution, n_target, ground_state, output_path,
                                max_display=50):
    ...
    csv_df = pd.DataFrame({
        ...
        'is_ground_state': [item[0] == ground_state for item in all_sorted]
    })
