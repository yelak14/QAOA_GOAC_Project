...
def main():
    print("=" * 60)
    print("QAOA with Standard Mixer (IBM Hardware)")
    print("=" * 60)
    ...
    p = 1  # Start with p=1 for hardware
    ...
    # Optimization loop with hardware
    ...
    plot_approximation_ratio_vs_depth(
        ...
        title="Standard Mixer (Hardware) - Approximation Ratio vs Depth"
    )
    ...
    plot_parameter_landscape(
        ...
        title="Standard Mixer (p=1, Hardware) - Parameter Landscape"
    )
